 ...
 * @author vagne
 */
public class ViewGeral extends javax.swing.JFrame {
     ...
     */
    public ViewGeral(BancoDeMidias sistema) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewGeral.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
